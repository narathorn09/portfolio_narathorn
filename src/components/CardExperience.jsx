...
const CardExperience = ({
  ...
  return (
    <div
      ...
      className="border border-indigo-600 rounded-md p-8 min-h-[300px] bg-white shadow-xl shadow-indigo-200 "
    >
      <time className="mb-1 text-sm font-medium leading-none text-gray-700 dark:text-gray-500">
        {dateRange}
      </time>
      <p className="mb-2 mt-1 text-sm font-normal leading-none text-gray-700 dark:text-gray-500">
        {subTitle}
      </p>
      <h3 className="text-lg font-semibold text-slate-700 dark:text-white mt-4">
        {title}
      </h3>
      <p className="text-base text-wrap font-normal text-gray-500 dark:text-gray-400">
        {description}
      </p>
