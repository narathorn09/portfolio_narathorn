...
const CardProject = ({
  ...
  return (
    <div
      className={`${className} border-t-4 border-indigo-600 hover:border-slate-800 hover:bg-gray-50 hover:cursor-pointer rounded-md p-8 min-h-[300px] bg-white shadow-md shadow-indigo-200 transition duration-200 ease-in-out transform`}
    >
